...
public class Packet {
    ...
    public Builder toBuilder(){
        return new Builder()
                ...
                .setPeerAddress(peerAddress.getHostAddress())
    ...
    public static Packet fromBuffer(ByteBuffer buf) throws IOException {
        ...
        builder.setPeerAddress(Inet4Address.getByAddress(host).getHostAddress());
    ...
    public static class Builder {
        ...
        public Builder setPeerAddress(String peerAddress) {
        	InetSocketAddress serverAddress = new InetSocketAddress(peerAddress, this.portNumber);
